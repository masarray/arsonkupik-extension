...
function bindEvents() {
  ...
  ui.supportDevelopmentButton?.addEventListener('click', () => openSupportPage().catch((error) => setHint(error.message)));
  ...
  ui.openStudioButton.addEventListener('click', openStudioPanel);
}
