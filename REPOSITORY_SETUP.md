...
git init
git add .
git commit -m "chore: publish ArSonKuPik 0.3.101"
git branch -M main
git remote add origin https://github.com/masarray/ArSonKuPik.git
...
5. Create release `v0.3.101`; the release workflow will attach the clean Web Store ZIP.
6. Add the website URL `https://masarray.github.io/ArSonKuPik/` to the repository profile.
